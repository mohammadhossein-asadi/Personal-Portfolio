const LoadingSpinner = () => {
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-white dark:bg-[#030a1c] z-50">
      <div className="relative w-full h-full flex justify-center items-center">
        ...
        <div className="rounded-full h-28 w-28 animate-bounce flex items-center justify-center text-gray-400 font-semibold text-xl dark:text-gray-200">
          Loading...
        </div>
      </div>
    </div>
